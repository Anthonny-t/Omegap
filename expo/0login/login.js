    ...
    form.addEventListener('submit', async (e) => {
      ...
      if (error) {
        ...
        mostrarMensaje('❌ Error al guardar el inicio de sesión', 'error');
      } else {
        mostrarMensaje('✅ Inicio de sesión guardado correctamente', 'success');
        setTimeout(() => {
          window.location.href = '/2inicio/index.html';
        }, 1000);
      }
    });
